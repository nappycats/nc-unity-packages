...
## [Unreleased]
### Added
- `NC_PKG_FOUNDATION` version define and fallback output path so generated keys land under `Nc.Keys.Tags.*` (Foundation) or `Assets/NappyCat/NcKeys.Generated/` when Foundation is absent.
### Changed
